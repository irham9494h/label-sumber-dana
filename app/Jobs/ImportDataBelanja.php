    ...
    public function handle(): void
    {
        foreach ($this->belanjas as $key => $belanja) {
            $unitSkpd = UnitSkpd::firstOrCreate([
                ...
                'nama' => str($belanja['NAMA UNIT SKPD'])->trim()->limit(255),
            ]);

            $urusan = Urusan::firstOrCreate([
                'kode' => str($belanja['KODE URUSAN']),
            ], [
                'nama' => str($belanja['NAMA URUSAN'])->trim()->limit(255),
            ]);
            ...
            $bidangUrusan = BidangUrusan::firstOrCreate([
                ...
                'nama' => str($belanja['NAMA BIDANG URUSAN'])->trim()->limit(255),
            ]);
            ...
            $program = Program::firstOrCreate(['kode' => str($belanja['KODE PROGRAM']), 'bidang_urusan_id' => $bidangUrusan->id], [
                'nama' => str($belanja['NAMA PROGRAM'])->trim()->limit(255),
            ]);
            ...
            $kegiatan = Kegiatan::firstOrCreate([
                ...
                'nama' => str($belanja['NAMA KEGIATAN'])->trim()->limit(255),
            ]);
            ...
            $subKegiatan = SubKegiatan::firstOrCreate([
                ...
                'nama' => str($belanja['NAMA SUB KEGIATAN'])->trim()->limit(255),
            ]);
            ...
            $standarHarga = StandarHarga::firstOrCreate([
                ...
                'nama' => str($belanja['NAMA STANDAR HARGA'])->trim()->limit(255),
                'spek' => str($belanja['SPESIFIKASI'])->trim()->limit(255),
            ]);
            ...
            $rincianBelanja = RincianBelanja::create([
                ...
                'kelompok' => !empty($belanja['PAKET/KELOMPOK BELANJA']) ? str($belanja['PAKET/KELOMPOK BELANJA'])->trim()->limit(255) : '',
                'keterangan' => !empty($belanja['KETERANGAN BELANJA']) ? str($belanja['KETERANGAN BELANJA'])->trim()->limit(255) : '',
                'sumber_dana_id' => $sumberDana ? $sumberDana->id : null,
                'nama_penerima_bantuan' => !empty($belanja['NAMA PENERIMA BANTUAN']) ? str($belanja['NAMA PENERIMA BANTUAN'])->trim()->limit(255) : '',
                'koefisien_murni' => !empty($belanja['KOEFISIEN MURNI']) ? str($belanja['KOEFISIEN MURNI'])->trim()->limit(255) : '',
                ...
                'koefisien' => !empty($belanja['KOEFISIEN']) ? str($belanja['KOEFISIEN'])->trim()->limit(255) : '',
